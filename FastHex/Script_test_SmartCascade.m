...
if alpha_value < dead_zone_alpha
    alpha_value = 0;
    cascade = true;
elseif alpha_value > pi - dead_zone_alpha
    alpha_value = pi;
    cascade = true;
else
    cascade = false;
...
ticks_horizontal = [-5, -2.5, 0, 2.5, 5];
...
if ~cascade
    ...
    scatter(listIntersections(1,:), listIntersections(2,:), 100, 'white', 'o', "filled", 'DisplayName', "Edges intersections")
    % end
